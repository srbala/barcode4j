...
public class EAN128 extends Code128 implements Configurable {
    ...
    public void configure(Configuration cfg) throws ConfigurationException {
        ...
        // Checksum mode
        getEAN128Bean().setChecksumMode(
                ChecksumMode.byName(cfg.getChild("checksum").getValue(ChecksumMode.CP_AUTO.getName())));
        // Checkdigit place holder
        getEAN128Bean().setCheckDigitMarker(getFirstChar(cfg.getChild("check-digit-marker").getValue("\u00f0")));
        // Template
        getEAN128Bean().setTemplate(cfg.getChild("template").getValue(""));
        // group seperator aka FNC_1
        getEAN128Bean().setGroupSeparator(getFirstChar(cfg.getChild("group-separator").getValue("\u00f1")));
